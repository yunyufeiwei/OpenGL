...
float pyrXrot = 40.0f, pyrYrot = 95.0f, torXrot = 35.0f;
...
void display(GLFWwindow* window, double currentTime)
{
	...
	glProgramUniform1f(renderingProgram, fLoc, -1.0f);		//翻转背面法向量
	glDrawArrays(GL_TRIANGLES, 0, numPyramidVertices);

	glCullFace(GL_BACK);									//渲染金字塔正面
