...
void init(GLFWwindow* window)
{
	...
	cameraX = 0.0f; cameraY = 0.0f; cameraZ = 32.0f;  //设置相机的位置，cameraZ表示了看向cube的距离
	setupVertices();
}
...
int main(void)
{
	...
	GLFWwindow* window = glfwCreateWindow(600, 600, "multipleCubes", NULL, NULL);
