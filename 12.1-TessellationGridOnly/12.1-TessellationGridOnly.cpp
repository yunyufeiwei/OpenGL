...
void display(GLFWwindow* window, double currentTime)
{
	...
	glPatchParameteri(GL_PATCH_VERTICES, 1);		//在使用曲面细分的代码中，GL_PATCHES是唯一允许的图元类型
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);		//指定如何光栅化，默认是GL_FILL，而当前使用GL_LINE，就可以看到线框显示方式
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "TessellationGridOnly", NULL, NULL);
