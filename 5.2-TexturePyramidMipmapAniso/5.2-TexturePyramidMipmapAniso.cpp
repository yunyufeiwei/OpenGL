...
void init(GLFWwindow* window)
{
	...
	cameraX = 0.0f; cameraX = 0.0f; cameraZ = 4.0f;
	...
	brickTexture = Utils::loadTexture("./Resources/brick1.jpg");		//如果在代码同级目录下的文件夹下，使用window的路径方式指定
}
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(600, 600, "TexturePyramid", NULL, NULL);
